...
Основной интерес проекта — не веб-часть, а SQL: схема в 3NF на 12 таблиц, рекомендации через цепочку CTE и работа с транзакциями и правами доступа на уровне БД.
...
Автор — Илья Баштовенко. Проект разрабатывался в связке с ИИ-агентом: постановка задачи, архитектурные решения и разбор результата — мои, значительная часть кода написана агентом под моим контролем.
